...
<nav class="pt-6 px-10 flex items-center justify-between 2xl:justify-around hidden md:flex uk-link-reset">
            ...
            <div class="flex font-lexend uppercase text-[12px] text-dark/80 lg:block hidden">
                <a href="index.php#overview" class="mx-5 font-medium hover:!text-dark transition ease-in duration-150">Home</a>
                <a href="index.php#services" class="mx-5 font-medium hover:!text-dark transition ease-in duration-150">Services</a>
                <a href="index.php#profiles" class="mx-5 font-medium hover:!text-dark transition ease-in duration-150">Profiles</a>
                <a href="feature/one.php" class="mx-5 font-medium hover:!text-dark transition ease-in duration-150">Features</a>
            </div>
          ...
          <div class="py-8 overflow-y-auto">
              <ul class="space-y-2 text-dark">
                ...
                <ul class="pt-6 space-y-2 text-dark">
                    <li>
                        <span class="px-2 uppercase font-medium font-lexend text-dark-tp">Home</span>
                    </li>
                    <li>
                       <a href="#services" class="flex items-center p-2 text-dark rounded-md hover:bg-dark-tp/10 transition duration-100 ">
                           <iconify-icon icon="ri:service-fill" width="25" height="22"></iconify-icon>
                          <span class="ml-5 font-montserrat tracking font-semibold">Services</span>
                       </a>
                    </li>
                   <li>
                       <a href="#profiles" class="flex items-center p-2 text-dark rounded-md hover:bg-dark-tp/10 transition duration-100 ">
                           <iconify-icon icon="ri:profile-fill" width="25" height="22"></iconify-icon>
                          <span class="ml-5 font-montserrat tracking font-semibold">Profiles</span>
                       </a>
                    </li>
                </ul>
