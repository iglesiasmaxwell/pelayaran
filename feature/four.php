    ...
    <body class="overflow-x-hidden bg-light/30" id="overview">
        ...
        <section class="lg:mr-10 flex lg:gap-10">
            ...
            <div class="h-full w-9/12 py-14 space-y-12 mx-auto">
                <h1 class="font-lexend font-bold text-2xl text-center uppercase">Count Salary Accurately</h1>
                    <?php
                        include_once('../layout/mockup.php');
                    ?>
                <p class="font-lexend font-light 2xl:text-center">Calculate and create variety of salary slips. Pay weekly, monthly or combination of both!</p>
            </div>
        </section>
