...
<?php
    ...
    $laptopmockupimage = "../image/mockup-img-order.jpg";
?>
</head>
    <body class="overflow-x-hidden bg-light/30" id="overview">
        ...
        <section class="lg:mr-10 flex lg:gap-10">
            ...
            <div class="h-full w-9/12 py-14 space-y-12 mx-auto">
                <h1 class="font-lexend font-bold text-2xl text-center uppercase">Store Attendance Records</h1>
                    <?php
                        include_once('../layout/mockup.php');
                    ?>
                <p class="font-lexend font-light 2xl:text-center">Record and monitor your employee's attendance on all of your devices.</p>
            </div>
        </section>
